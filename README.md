...
- **Swift 4.x**: >= 4.4.0 - Latest is 4.4.2 [Download here](https://github.com/malcommac/SwiftDate/releases/tag/4.4.2) (`pod 'SwiftDate'`)
...
* The **latest [full class documentation is available here](http://cocoadocs.org/docsets/SwiftDate/4.4.2/)**
...
- **Swift 4.x**: >= 4.4.0 - Latest is 4.4.2 [Download here](https://github.com/malcommac/SwiftDate/releases/tag/4.4.2).
...
* Persian (made by [KiKi](https://github.com/iKiKi), since 4.4.2)
...
- **Swift 4.x**: >= 4.4.2 [Download here](https://github.com/malcommac/SwiftDate/releases/tag/4.4.2).
- **Swift 3.x**: Latest compatible version is 4.3.0 [Download here](https://github.com/malcommac/SwiftDate/releases/tag/4.3.0)
- **Swift 2.3**: Latest compatible version is 3.0.9 on [swift_23 branch](https://github.com/malcommac/SwiftDate/tree/feature/swift_23)
